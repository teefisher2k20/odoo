...
class ValidateAccountMove(models.TransientModel):
    ...
    force_post = fields.Boolean(
        string="Force", help="Entries in the future are set to be auto-posted by default. Check this checkbox to post them now.")
